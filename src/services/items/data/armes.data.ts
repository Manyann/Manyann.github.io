import { Arme } from '../models/item.model';

export type OrigineResolver = (zone: string, itemType: string) => string;

export const getArmesData = (getOrigine: OrigineResolver, zone: string = 'commun'): Arme[] => {
  return [
      //#region  Dagues
      {
