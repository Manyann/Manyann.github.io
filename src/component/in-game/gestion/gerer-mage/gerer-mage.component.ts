...
private buildMetierList():Array<Metier>{
  const list : Array<Metier> = [
    ...
    },
    {
      ...
      force: new Caracteristique(),
      chance: new Caracteristique(),
      caracteristiques : ["Enlève jusqu'à 5EA initiales pour les ajouter à ses EV initiales"],
      restrictions : [],
    ...
    },
    {
      ...
      competencesHerites :["Ambidextrie","Désamorcer","Déplacement silencieux","Pister","Ressemble à rien","Serrurier"],
    ...
    },
    {
      ...
      force: new Caracteristique(),
      chance: new Caracteristique(),
      caracteristiques : ["La fame : La célébrité et son groupe ont 50% dans les auberges / tavernes / restaurants",
