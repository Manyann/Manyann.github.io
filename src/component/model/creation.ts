  ...
  static getAllOrigine(): Array<Origine> {
    const list: Array<Origine> = [
      ...
      },
      {
        ...
        restrictionsMetierShortCode: ['PR', 'AR', 'BE', 'IN', 'DM', 'WA'],
        isForbidden: false,
      },
      {
        nom: 'Demi Orque',
    ...
    const list: Array<Metier> = [
      ...
      },
      {
        ...
        caracteristiques: [
          ...
          'Tous les trois niveaux l’ingénieur ne gagne pas une nouvelle compétence, il peut invoquer un Méca de plus en combat et choisir un supplément de Méca',
        ],
        restrictions: ['3PR Max'],
