...
export class CreationHelper{
    ...
    static getAllOrigine():Array<Origine>{
        ...
        const list : Array<Origine> = [
            ...
            restrictionsMetierShortCode: ['PR','VO','AR','BE','AT','RA','IN','DM','MG','SO','CR','PI','CP','WA'],
            isForbidden : false
            },
            {
            nom:"Nain",
            ...
            restrictionsMetierShortCode: ['PR','VO','AR','AT','RA','IN','DM','GR','WA'],
            isForbidden : false
            },
            {
            nom:"Demi Elfe",
            ...
            restrictionsMetierShortCode: ['PR','VO','BE','IN','DM','MG','GR','FO','CO','WA'],
            isForbidden : false
            },
            {
            nom:"Elfe Noir",
            ...
            force: {type:"max",nombre:"12-"},
            chance: new Caracteristique(),
            caracteristiques : ["25EV","+1CHA niveau 2 et 3","50% de chance de contre attaquer après une esquive"],
            ...
            restrictionsMetierShortCode: ['PR','BE','AT','IN','MG','GR','AC','WA'],
            isForbidden : false
            },
            {
            nom:"Orque",
            ...
            restrictionsMetier : ['Prêtre',"Artiste",'Bourgeois','Ingénieur','Démonologue'],
            ...
            restrictionsMetier : ['Prêtre','Voleur',"Artiste",'Bourgeois','Artisant','Ranger','Ingénieur','Démonologue','Mage'],
            restrictionsMetierShortCode: ['PR','VO','AR','BE','AT','RA','IN','DM','MG','CP','SO','GL','PI','WA'],
            isForbidden : false
            },
            {
            nom:"Centaure",
            ...
            restrictionsMetierShortCode: ['PR','VO','AR','BE','IN','DM','MG','HE','AC','BZ','PI','CR','CE','IQ','WA'],
            isForbidden : false
            },
            {
            ...
            restrictionsMetierShortCode: ['PR','VO','RA','IN','DM','MG','GR','FO','FR','WA'],
            isForbidden : false
            },
            {
            nom:"Walkyrie",
            ...
            restrictionsMetierShortCode: ['PR','VO','AR','BE','AT','RA','IN','DM','MG','GR','WA'],
            isForbidden : false
            },
            {
            nom:"Samurai",
            ...
            restrictionsMetierShortCode: ['PR','VO','AR','RA','IN','DM','MG','HE','PI','BZ','GL','WA'],
            isForbidden : false
            },
        ];
        return list;
    ...
    static getAllMetier():Array<Metier>{
        ...
        const list : Array<Metier> = [
            ...
            caracteristiques : ["Larcin : Le voleur gagne 5PO par ennemie humain affronté","Le voleur peut esquiver tous les tours, mais AD-3 un tour sur deux."],
            ...
            force: new Caracteristique(),
            chance: new Caracteristique(),
            caracteristiques : ["Maître du Tai-Jutsu : Les attaques à main nue du ninja sont considéré comme tranchante","Le Ninja peut esquiver tous les tours","Frappe des ombres : Le ninja à dégats * 2 dans le dos peut importe l'arme"],
            restrictions : ["2PR Max"],
            competencesHerites :["Ambdiextrie","Désamorcer","Déplacement silencieux","Pister","Ressemble à rien","Serrurier"],
            autres : ["Maitre des ombres : invisible dans les ombres", "Permutation : Le ninja peut échanger de place avec un allié"],
            shortCodeParents:["RO"],
            isForbidden : false, 
            subMetiers : []
            },
            ...
            restrictions : ["4PR Max"],
            competencesHerites :["Chercher des noises","Déplacement silencieux","Frapper lachement","Méfiance","Pister"],
            autres : ["Collectionneur : Si le chasseur de monstres combat des créatures (animaux aussi), et que le chasseur de monstres achève l'un d'eux. Il gagne un trophé de ce monstre",
            ...
            autres : ["Agitateur : Sait galvaniser la foule","Sort de feu de niveau 3 / magma niveau 3"],
            isForbidden : false, subMetiers : [],
