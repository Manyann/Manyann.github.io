  ...
  static getAllMetier(): Array<Metier> {
    const list: Array<Metier> = [
      ...
      },
      {
        ...
        autres: [
          'Bouclier de Foi, crée un bouclier avec 2*EA de puissance. Les attaques enlèvent de la puissance au bouclier avant de toucher la cible du templier. Un critique détruit le bouclier',
        ],
        shortCodeParents: ['PL'],
        isForbidden: false,
        subMetiers: [],
      ...
      },
      {
        ...
        caracteristiques: [
          ...
          "Précision mortelle : Les dagues de l'assassin ignore l'armure",
        ],
        restrictions: ['3PR Max'],
        competencesHerites: ['AM', 'DS', 'IN', 'PI', 'CH'],
        autres: [
          "Fiole : Sur un test AD l'empoisonneur peut verser du poison dans un plat, verre, etc. Ou en combat mais efficacité /2. Test AD/INT pour fabrication",
      ...
      },
      {
        ...
        chance: new Caracteristique(),
        caracteristiques: [
          'Maître du Tai-Jutsu : Les attaques à main nue du ninja sont considéré comme tranchante',
          'Le Ninja peut esquiver tous les tours',
        ...
        autres: [
          'Maitre des ombres : invisible dans les ombres',
      ...
      },
      {
        ...
        chance: new Caracteristique(),
        caracteristiques: [
          'Sens du détails : +2 aux épreuves de détection',
          "Maquillage : il peut se faire passer pour quelqu'un d'autre sur un test INT / CHA",
        ],
        restrictions: [],
      ...
      },
      {
        ...
        force: new Caracteristique(),
        chance: new Caracteristique(),
        caracteristiques: ['-3EV', '15 EA', '1DEA level up'],
        restrictions: ['3PR Max'],
      ...
      },
      {
        ...
        autres: ['Récit épique: +1D20 EA apres combat'],
        shortCodeParents: ['BD'],
        isForbidden: false,
        subMetiers: [],
      },
      ...
      },
      {
        ...
        autres: [
          ...
          'Tableau de chasse : Tous les 5 trophés récoltés, le chasseur de monstres gagne 1PI contre créature',
      ...
      },
      {
        ...
        chance: { type: 'min', nombre: '10+' },
        caracteristiques: [
          'Dégats de feu réduis de moitié',
          '+1PI armes à feu',
        ],
        restrictions: ['4PR Max'],
      ...
      },
      {
        ...
        chance: new Caracteristique(),
        caracteristiques: [
          "L'ingénieur peut construire des Mécas",
          'Tous les trois niveaux l’ingénieur ne gagne pas une nouvelle compétence, il peut invoquer un Méca de plus en combat. Ses Mécas évoluent',
        ],
        restrictions: ['3PR Max'],
        competencesHerites: ['SE'],
        autres: [
          'L’ingénieur dispose de 2 points de Méca par tour pour effectuer des actions de Meca',
        ],
        isForbidden: false,
        subMetiers: [],
        shortCodeParents: ['IN'],
      ...
      },
      {
        ...
        autres: [
          ...
          'Sort de feu de niveau 3 / magma niveau 3',
        ],
        isForbidden: false,
        subMetiers: [],
      ...
      },
      {
        ...
        caracteristiques: [
          ...
          '-2PRD',
          '+2AT',
          'Rage : Le berzerk gagne 2 de rage par EV manquant',
        ],
      ...
      },
      {
        ...
        autres: [
          '+1 PI pour chaque attaque réussie. Réinitialise si pas de dégats infligés',
        ],
        shortCodeParents: ['SO'],
        isForbidden: false,
        subMetiers: [],
      },
      {
        ...
        autres: [
          'Pillage : Prend 10% a chacun des alliés pour les loots',
      ...
      },
      {
        ...
        chance: new Caracteristique(),
        caracteristiques: [
          '20EV si humain, sinon -30%',
          '30EA',
          'EV ou EA au level up',
        ],
        restrictions: [
      ...
      },
      {
        ...
        competencesHerites: [],
        autres: [
          'Soin des blessures légères : Allié uniquement. 10 EV. Donne 15EV',
      ...
      },
      {
        ...
        autres: [
          ' Laser purificateur. XEV. 2D+X magique touche les ennemies en ligne (Magie Phy+2)',
      ...
      },
      {
        ...
        chance: new Caracteristique(),
        caracteristiques: [
          'Justice vertueuse : 3 bon points / 2 mauvais points',
        ],
        restrictions: [],
        competencesHerites: ['CLA', 'PS'],
        autres: [
          'Soin des blessures majeures : Allié uniquement. X EV. Donne 1.5*X EV',
